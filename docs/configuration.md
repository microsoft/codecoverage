...
| IncludeTestAssembly | `True`, `False` | `True` | `False` ( version <= 18.1.X) `True` ( version >= 18.3.X) | Indicates if coverage should be collected for tests projects | `<IncludeTestAssembly>True</IncludeTestAssembly>` | `"IncludeTestAssembly": true` | 17.14 |
